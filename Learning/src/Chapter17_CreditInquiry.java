...
public class Chapter17_CreditInquiry {

	private Chapter17_MenuOption accountType;
	private Scanner input;
	private final static Chapter17_MenuOption[] choices = { Chapter17_MenuOption.ZERO_BALANCE,
			Chapter17_MenuOption.CREDIT_BALANCE, Chapter17_MenuOption.DEBIT_BALANCE,
			Chapter17_MenuOption.END };
	...
	{
		if ( ( accountType == Chapter17_MenuOption.CREDIT_BALANCE ) && ( balance < 0 ) )
			return true;
		else if ( ( accountType == Chapter17_MenuOption.DEBIT_BALANCE ) && ( balance > 0 ) )
			return true;
		else if ( ( accountType == Chapter17_MenuOption.ZERO_BALANCE ) && ( balance == 0 ) )
			return true;
	...
	private Chapter17_MenuOption getRequest()
	{
	...
	public void processRequests()
	{
		...
		while ( accountType != Chapter17_MenuOption.END )
		{
			switch ( accountType )
			{
			case ZERO_BALANCE:
